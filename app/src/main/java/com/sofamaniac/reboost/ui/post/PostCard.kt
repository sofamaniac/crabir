 ...
 *
 * @param post The [com.sofamaniac.reboost.domain.model.PostData] data to display.
 ...
 * @param onClick A lambda that takes a [com.sofamaniac.reboost.domain.model.PostData] and is called before navigating to the post.
